...
class GameWebView: UIView {
    ...
    init(viewModel: GameViewModel) {
        ...
        setupUI()
//        if SettingData.share.useCustomWebView {
//            if let string = Bundle.main.path(forResource: "index", ofType: "html") {
...
//        }
    ...
    func loadUrl(gameId: String, roomId: String, toUser: String? = nil, roleType: GameRoleType, vendorId: String) {
...
//        }
//        else {
//            webView.loadHTMLString("<p></p>", baseURL: nil)
//        }
    }
